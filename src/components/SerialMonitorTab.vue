      ...
      <v-card-title class="monitor-card__title">
        ...
        <div class="monitor-card__actions">
          ...
          <v-text-field
            ...
            hide-details
            :placeholder="$t('serialMonitor.filter.placeholder')"
            clearable
...
{{ displayText }}
        ...
        >
          {{ $t("serialMonitor.terminal.empty") }}
        </div>
      </v-card-text>
    </v-card>
